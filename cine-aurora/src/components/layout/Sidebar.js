...
export default function Sidebar() {
  ...
  const isAdmin = currentUser?.email === 'matheus0mendes0marinho@gmail.com';
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar__top">
        ...
        {profileOpen && (
          <div className="sidebar__profile-menu">
            <div className="sidebar__profile-email">{currentUser?.email || 'Convidado'}</div>
            {isAdmin && (
              <button
                type="button"
      ...
      <div className="sidebar__footer sidebar__footer--minimal">
        <button className="sidebar__icon-btn" onClick={handleLogout} title="Sair">
